...
use crate::bn_eth::ecp::ECP;
use crate::bn_eth::ecp2::ECP2;
use crate::bn_eth::fp::FP;
use crate::bn_eth::fp12;
use crate::bn_eth::fp12::FP12;
use crate::bn_eth::fp2::FP2;
use crate::bn_eth::fp4::FP4;
...
pub fn gs(ee: &BIG) -> [BIG; 4] {
    ...
    if ecp::CURVE_PAIRING_TYPE == ecp::BN {
        ...
        // David: patched.
        let ee_NEG = BIG::modneg(&ee, &q);
        v[1] = BIG::modadd(&v[1], &ee_NEG, &q);
        v[2] = BIG::modadd(&v[2], &ee_NEG, &q);
