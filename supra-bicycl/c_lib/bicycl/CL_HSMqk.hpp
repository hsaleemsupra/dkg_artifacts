...
namespace BICYCL
{
  ...
  class CL_HSMqk
  {
    ...
    public:
      ...
      /**
        * Setup of the cryptosystem given all parameters
        */
        CL_HSMqk (const Mpz &q, size_t k, const Mpz &p, bool compact_variant, bool large_message_variant,
                  const Mpz &M, const ClassGroup& Cl_DeltaK, const ClassGroup& Cl_Delta, const Mpz &exponent_bound,
                  const QFI& h, const QFI& h_e_precomp, const QFI& h_d_precomp, const QFI& h_de_precomp, size_t d, size_t e);
      /**
