...
RITUAL_EXPORT BICYCL::CL_HSMqk* ctr_bicycl_ffi_BICYCL_CL_HSMqk_CL_HSMqk5(const BICYCL::Mpz* q, size_t k, const BICYCL::Mpz* p, bool compact_variant,
bool large_message_variant, const BICYCL::Mpz* m, const BICYCL::ClassGroup* cl_deltak, const BICYCL::ClassGroup* cl_delta,
const BICYCL::Mpz* exponent_bound, BICYCL::QFI* h, BICYCL::QFI* h_e_precomp, BICYCL::QFI* h_d_precomp, BICYCL::QFI* h_de_precomp,
size_t d, size_t e) {
  return new BICYCL::CL_HSMqk(*q, k, *p, compact_variant, large_message_variant, *m, * cl_deltak, *cl_delta, *exponent_bound, *h, *h_e_precomp, *h_d_precomp, *h_de_precomp, d, e);
}
