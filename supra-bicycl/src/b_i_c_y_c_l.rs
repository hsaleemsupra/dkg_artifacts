...
impl CLHSMqk {
    ...
    /// Calls C++ function: <span style='color: green;'>```[constructor] void BICYCL::CL_HSMqk::CL_HSMqk(const BICYCL::CL_HSMqk& C, bool compact_variant)```</span>.
    pub unsafe fn from_c_l_h_s_mqk_all(
        q: impl ::cpp_core::CastInto<::cpp_core::Ref<crate::b_i_c_y_c_l::Mpz>>,
        k: usize,
        p: impl ::cpp_core::CastInto<::cpp_core::Ref<crate::b_i_c_y_c_l::Mpz>>,
        compact_variant: bool,
        large_message_variant: bool,
        m: impl ::cpp_core::CastInto<::cpp_core::Ref<crate::b_i_c_y_c_l::Mpz>>,
        cl_deltak: impl ::cpp_core::CastInto<::cpp_core::Ref<crate::b_i_c_y_c_l::ClassGroup>>,
        cl_delta: impl ::cpp_core::CastInto<::cpp_core::Ref<crate::b_i_c_y_c_l::ClassGroup>>,
        exponent_bound: impl ::cpp_core::CastInto<::cpp_core::Ref<crate::b_i_c_y_c_l::Mpz>>,
        h: impl ::cpp_core::CastInto<::cpp_core::Ref<crate::b_i_c_y_c_l::QFI>>,
        h_e_precomp: impl ::cpp_core::CastInto<::cpp_core::Ref<crate::b_i_c_y_c_l::QFI>>,
        h_d_precomp: impl ::cpp_core::CastInto<::cpp_core::Ref<crate::b_i_c_y_c_l::QFI>>,
        h_de_precomp: impl ::cpp_core::CastInto<::cpp_core::Ref<crate::b_i_c_y_c_l::QFI>>,
        d: usize,
        e: usize
    ) -> ::cpp_core::CppBox<crate::b_i_c_y_c_l::CLHSMqk> {
        let ffi_result = crate::__ffi::ctr_bicycl_ffi_BICYCL_CL_HSMqk_CL_HSMqk5(
            ::cpp_core::CastInto::<::cpp_core::Ref<crate::b_i_c_y_c_l::Mpz>>::cast_into(q)
                .as_raw_ptr(),
            k,
            ::cpp_core::CastInto::<::cpp_core::Ref<crate::b_i_c_y_c_l::Mpz>>::cast_into(p)
            ...
            ::cpp_core::CastInto::<::cpp_core::Ref<crate::b_i_c_y_c_l::Mpz>>::cast_into(m)
                .as_raw_ptr(),
            ::cpp_core::CastInto::<::cpp_core::Ref<crate::b_i_c_y_c_l::ClassGroup>>::cast_into(cl_deltak)
                .as_raw_ptr(),
            ::cpp_core::CastInto::<::cpp_core::Ref<crate::b_i_c_y_c_l::ClassGroup>>::cast_into(cl_delta)
                .as_raw_ptr(),
            ::cpp_core::CastInto::<::cpp_core::Ref<crate::b_i_c_y_c_l::Mpz>>::cast_into(exponent_bound)
                .as_raw_ptr(),
            ::cpp_core::CastInto::<::cpp_core::Ref<crate::b_i_c_y_c_l::QFI>>::cast_into(h)
                .as_raw_ptr(),
            ::cpp_core::CastInto::<::cpp_core::Ref<crate::b_i_c_y_c_l::QFI>>::cast_into(h_e_precomp)
                .as_raw_ptr(),
            ::cpp_core::CastInto::<::cpp_core::Ref<crate::b_i_c_y_c_l::QFI>>::cast_into(h_d_precomp)
                .as_raw_ptr(),
            ::cpp_core::CastInto::<::cpp_core::Ref<crate::b_i_c_y_c_l::QFI>>::cast_into(h_de_precomp)
                .as_raw_ptr(),
            d,
            e
        );
